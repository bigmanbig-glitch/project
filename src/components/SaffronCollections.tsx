...
function SaffronRail({ type }: { type: SaffronType }) {
  ...
  return (
    <div ref={ref} className={`reveal ${isVisible ? 'is-visible' : ''}`}>
      ...
      className="flex snap-x snap-mandatory gap-5 overflow-x-auto overflow-y-auto scroll-smooth [touch-action:auto] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
      >
