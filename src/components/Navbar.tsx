      ...
      >
        <nav className="mx-auto flex max-w-8xl items-center justify-between px-5 sm:px-8">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            <button
              onClick={open}
             className="group relative flex items-center gap-2 rounded-full border border-saffron-400/60 bg-espresso-800 px-3 py-2 text-sm font-medium text-cream-100 transition-all hover:border-saffron-400/60 hover:bg-espresso-700/60 sm:px-4"
